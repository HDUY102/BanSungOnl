...
struct Z_CompiledInDeferFile_FID_Code_C___Training_BanSungOnl_BanSungOn_Source_BanSungOnl_Items_ItemAmmoRif_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AItemAmmoRif, AItemAmmoRif::StaticClass, TEXT("AItemAmmoRif"), &Z_Registration_Info_UClass_AItemAmmoRif, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AItemAmmoRif), 2529615909U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Code_C___Training_BanSungOnl_BanSungOn_Source_BanSungOnl_Items_ItemAmmoRif_h_2728593441(TEXT("/Script/BanSungOnl"),
