...
void EmptyLinkFunctionForGeneratedCodeBanSungOnl_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_BanSungOnl()
	{
		if (!Z_Registration_Info_UPackage__Script_BanSungOnl.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_BanSungOnl_Score__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_BanSungOnl(Z_Construct_UPackage__Script_BanSungOnl, TEXT("/Script/BanSungOnl"), Z_Registration_Info_UPackage__Script_BanSungOnl, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x83370788, 0xBC1334A0));
